...
globle_footer += '<li><a href="basic.html">投资者权益须知</a></li>';
globle_footer += '</ul>';
globle_footer += '<div>Copyright © 2016-2018 fengrunjf.com All rights reserved</div>';
globle_footer += '<div>北京沣润金服有限公司版权所有</div>';
globle_footer += '</div>';
globle_footer += '</div>';
